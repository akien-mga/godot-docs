...
.. warning::
    ...
    `here <https://stackoverflow.com/questions/4221176/excel-to-csv-with-utf8-encoding>`_.

    We recommend using `LibreOffice <https://www.libreoffice.org/>`_ or Google Sheets instead.
