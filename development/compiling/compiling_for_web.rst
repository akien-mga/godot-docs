...
-  `Emscripten 1.38.27+ <http://kripken.github.io/emscripten-site>`_: If the version available
   per package manager is not recent enough, the best alternative is to install
   using the `Emscripten SDK <http://kripken.github.io/emscripten-site/docs/getting_started/downloads.html>`_
-  `Python 2.7+ or Python 3.5+ <https://www.python.org/>`_
